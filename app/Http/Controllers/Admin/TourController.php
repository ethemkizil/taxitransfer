...
class TourController extends Controller
{
	...
	public function create()
	{
        ...
        return view($this->view_path.'.create', compact("tourCategories"), compact("locations"));
	}
	...
	public function edit($id)
	{
		...
		return view($this->view_path.'.edit',compact('item', "tourCategories", "locations"));
	}
