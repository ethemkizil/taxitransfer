...
class PriceController extends Controller
{
    ...
    protected $model = "";
    protected $route_path = "price";
    protected $view_path = "price";
    protected $validations = [
        'start_location_id' => 'required',
        'stop_location_id' => 'required',
        'vehicle_id' => 'required',
    ];

    public function __construct(){
        $this->view_path = "admin.".$this->view_path;
        $this->module_name = "Fiyat";
    ...
    public function create()
    {
        ...
        return view($this->view_path.'.create', compact('locations', 'vehicles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($data['roundtrip']==1){
            $data['start_location_id'] = $request->input('stop_location_id');
            $data['stop_location_id'] = $request->input('start_location_id');
            $this->model->create($data);
        }
    ...
    public function edit($id)
    {
        ...
        return view($this->view_path.'.edit',compact('item', 'locations', 'vehicles'));
    }
