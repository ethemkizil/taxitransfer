...
use App\DriversPayment;
use Illuminate\Http\Request;
use View;

class DriversPaymentController extends Controller
{
	protected $module_name = "";
	protected $model = "";
	protected $route_path = "driverspayment";
	protected $view_path = "driverspayment";
	...
	public function __construct(){
		...
		$this->module_name = "DriversPayment";
		$this->model = new DriversPayment();
