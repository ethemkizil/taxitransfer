...
class DriversAddressController extends Controller
{
	...
	protected $model = "";
	protected $route_path = "driversaddress";
	protected $view_path = "driversaddress";
	...
	public function __construct(){
		...
		$this->module_name = "DriversAddress";
		$this->model = new DriversAddress();
